...
//		translate();
	...
	private String readFile(File file) {
		...
		try {
			...
			/* TODO - Implement better error handling (low priority). While this try/catch statement is required, I'm
			 *        not sure the exception is ever thrown. That is, I'm not sure if it is possible for the FileChooser
			 *        to return a non-null File that does not exist. */
			e.printStackTrace();
			return null;
		}
		StringBuilder stringBuilder = new StringBuilder();
		...
		scanner.close();
		// The above method will have one extra line-break at the very end (for non-empty files),
