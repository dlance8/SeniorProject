...
public class Parser extends MyProcess {
	private ArrayList<Token> tokens;
	public NonterminalNode root;
	...
	private boolean methodInvocation() {
		return accept(Nonterminal.METHOD_INVOCATION, () -> acceptAny(
			...
			() -> {
				...
				expressionName.getChildren().remove(expressionName.size() - 1);
				currentParent.getChildren().add(dot);
				...
				// { Identifier , "." } , Identifier , "." , [ TypeArguments ] , Identifier , "(" , [ ArgumentList ] , ")"
